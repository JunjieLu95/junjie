...
#        vna.stopFrq=2.1E9
#vna.power = -20
vna.numberOfTotalPoints=1601
vna.numberofPoints=1601
vna.nPointsPerWindow=1601
vna.nWindows=1
vna.iFBandWidth=100
vna.averageFlag=False
vna.averageNum=0
vna.setTimeOut(timeout=2000000L)
...
ps.openPort()
ini_ps4 =100000
ps.moveToAbs(4, ini_ps4)

time.sleep(20)

ini_ps2 =58000

ps.moveToAbs(2, ini_ps2)
time.sleep(10)
...
savePath = "/home/qc/PowerFolders/Quantenchaos/High_sym_NMR/measurements/Junjie_Lu/230607_Ygraph_pos_l2_60100_60600_scan3_test/"
...
#savePath = "./measurements/100122/vorversuche_neue_dioden/mn2/"
fileNamePattern = "Ygraph_PS2={}_PS4={}.xmldat"

pos_array_scan = np.linspace(60100, 60600, 101, dtype = int)
#pos_array_scan = [60600, 60680]
#pos_array_scan = [ 108000]
pos1_array_scan = np.linspace(113000, 133000, 201, dtype = int)


for pos_ps2 in pos_array_scan:
    ps.moveToAbs(2, pos_ps2)
    time.sleep(5)
    ps.moveToAbs(4, ini_ps4)
    time.sleep(10)
    for pos_ps4 in pos1_array_scan:
        ps.moveToAbs(4,pos_ps4)
        time.sleep(1)
        filename = fileNamePattern.format(pos_ps2, pos_ps4)
#        print(filename)
        try:
